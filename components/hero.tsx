...
export function Hero() {
  return (
    <section className="min-h-screen relative overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center mb-8 animate-fade-in-up">
            <div className="bg-white/10 backdrop-blur-xl rounded-full p-4 shadow-2xl shadow-blue-500/20 border border-white/20">
              <div className="flex items-center">
                <Avatar className="w-8 h-8 mr-3 ring-2 ring-blue-300/50 ring-offset-2 ring-offset-transparent">
                ...
                <div className="text-sm text-white/90">
                  ...
                  <span>That was the easiest repair I've ever done! 🔧</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12 animate-fade-in-up animation-delay-200">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
              ...
              <span className="bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent font-semibold">
                skilled repair heroes on the planet.
              </span>
            </p>
          </div>
          ...
          <div className="mb-16 animate-fade-in-up animation-delay-400">
            <Link href="/repair-request">
              <Button className="relative bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 text-white px-12 py-6 rounded-full text-xl font-semibold shadow-2xl shadow-blue-500/40 hover:shadow-3xl hover:shadow-blue-500/50 transform hover:scale-110 transition-all duration-500 group overflow-hidden">
                <span className="relative z-10 flex items-center">
                  Start repairing in seconds
                  <Sparkles className="ml-3 w-6 h-6 animate-spin" />
                </span>
          ...
          {/* Social Proof */}
          <div className="text-sm text-white/60 animate-fade-in-up animation-delay-600">
            Used by <span className="font-semibold text-blue-300">5,000+</span> households & repair shops in{" "}
      ...
      <div className="absolute top-20 left-8 transform -rotate-12 hidden lg:block animate-float">
      ...
      <div className="absolute top-32 right-12 transform rotate-6 hidden lg:block animate-float animation-delay-1000">
      ...
      <div className="absolute bottom-32 left-16 transform rotate-3 hidden lg:block animate-float animation-delay-2000">
      ...
      <div className="absolute bottom-20 right-8 transform -rotate-6 hidden lg:block animate-float animation-delay-3000">
        <Card className="w-64 bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20 rounded-3xl hover:shadow-3xl hover:scale-105 transition-all duration-500">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
      ...
      <div className="absolute top-1/2 left-4 transform -translate-y-1/2 rotate-45 hidden xl:block animate-spin-slow">
      ...
      <div className="absolute top-1/3 right-4 transform rotate-12 hidden xl:block animate-bounce">
      ...
      <div className="absolute bottom-1/3 left-1/4 transform -rotate-12 hidden xl:block animate-pulse">
